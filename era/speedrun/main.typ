...
*Congressional Staffer Scenario Update #comment[My notes, will be removed. Need to fix the above].* “Leveraging commercially available solutions into an integrated capabilities approach will accelerate the use of advanced AI as part of our Joint mission essential tasks in our warfighting domain as well as intelligence, business, and enterprise information systems.” (CDAO one is the main one to cite.)
OpenAI separately revealed that it had won its first Pentagon contract #cite(<openaiIntroducingOpenAIGovernment2025>). It would pilot a \$200 million program to "develop prototype frontier AI capabilities to address critical national security challenges in both warfighting and enterprise domains," according to the US Department of Defense. #cite(<u.s.departmentofdefenseContractsJune162025>) (More about this here: https://era2023.slack.com/archives/C0922JMFZNJ/p1751808702318539). OpenAI quietly removing their statement that they wouldn't work with the US government for defense. OpenAI already in collab with US National Labs, Air Force Research Laboratory, NASA, NIH, and the Treasury. Their models already deployed for the Commonwealth of Pennsylvania (tracking state governments sounds important, may be a canary in the coal mine for influence(?) considering their early adoption and low mass.)
Anthropic already AI being deployed at the highest levels of government. Also received a \$200 million ceiling contract. Much less likely that these would be deployed from the bottom-up. Does seem to be creeping into the government. 10,000 scientists, researchers, and staff already using Claude in a national security lab (LLNL) for nuclear deterrence, energy security, and materials science. #cite(<anthropicClaudeGovModels>). Mapping the diffusion of these models across gov seems important.
xAI also announced models including Grok 4 available to governments #cite(<xaiAnnouncingGrokGovernment2025>). GSAi by xAI used to bolster productivity of 12,000 GSA employees(? TODO: investigate)
Cohere had less than \$50 mil apparently in some kind of contract.

Also it seems like a substantial chunk of the US infrastructure runs on MicroSoft and Azure, where there are even Azure classified regions for which OpenAI's models will be deployed to.

You’d also have to review OMB guidance from March, and the National Security Memorandum on AI from last year.

*Total ceiling is close to \$850 million*

- Individual Agencies: Make final decisions about what their employees actually use

// Even my updates seem important to write about, not everyone knows how AI is being used here.
Some push to incorporate coding tools into various departments “Sometimes doing nothing is not an option and you have to accept a lot of risk,” says a former government official familiar with these processes. #cite(<daveElonMusksDOGE>)

LLMs in the US Government: https://chatgpt.com/s/t_6876257c124481919e7db60055c22a33
And a Claude Diagram presenting this information: https://claude.ai/public/artifacts/73138bf2-01b2-42ff-84c2-8d5b6f691820
- FDA -- Elsa internal model for clinical-trial review
- HHS (Health and Human Services) + CDC -- 271 AI Use Cases with ChatCDC
- VA -- OpenAI + Opensource two chatbots for care-providing
- State Dept. -- NorthStar (translation, email, drafting, policy lookup), anthropic and LLaMa
- GSA -- GSAi planned for 12,000 staff. Early contract-analysis prototype already live.
- FAA, IRS, NSF, EPA	-- Multiple models
- DoD – CDAO sandboxes open to ~60 k unclassified users; separate JWICS/SIPR LLM silo for ~30 k cleared analysts. (CHECK)
- Civilian health cluster (HHS/FDA/CDC/NIH) – agency‑wide access (~25 k) behind GovCloud walls.

The GSA has \$16.36 billion available to award https://www.usaspending.gov/agency/general-services-administration?fy=2025, if I understand correctly this might be

A lot of issues can still exist with models behind governmental walls.

*Congressional Staffer Scenario Analysis.* The situation above is clearly a national security issue. Every one of these millions of tasks being delegated to AI results in less power over our legislation and opportunities for AI biases
...
*Rapid Development.* There have been rapid improvements in the capabilities of foundational models without any fundamental insights into the nature of intelligence. Beyond the invention of the transformer and the Large Language Model, a considerable amount of improvements from GPT-2, a 2019 model barely able to string coherent sentences together, to 2025 models like o3, capable of automating tasks that would take software engineers over an hour and a half to complete, compose full essays, and achieve impressive scores on math benchmarks #comment[eh, not best examples], arise mostly from scaling existing practices and implementing intelligent but relatively mundane tricks, with incremental 1% improvements leading to exponential growth. A METR study indicates that the length of software engineering tasks foundational models can do is doubling every 7 months #comment[cite METR], which may lead to a future where AI automates or augments its own research and development, creating feedback loops boosting progress faster than is currently humanly capable.
#comment[Also recent SWE uplift study by METR #cite(<MeasuringImpactEarly20252025>) showing that AI enabled tooling actually makes developers slower. Also idk if worth mentioning intelligence explosion or "country of geniuses in a data center" Amodei. But even the PERCEPTION of it being helpful (even if harmful/incapable) is enough for it to diffuse. Diffusion is the right question here and development only helps so much in that it enables diffusion.] There is trillions of dollars in investment going towards the development of this technology and lots of international attention. #comment[find source]
...
*Lack of Transparency / Opportunity for Hidden Loyalties.* The "bitter lesson"
...
// *Other Work.*
// - AI-enabled coups paper #cite(<davidsonAIEnabledCoupsHow2025>) uses a very similar framing, but applied specifically to military technology.
