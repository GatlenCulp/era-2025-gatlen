...
While AI shares many similarities to other technologies, a few properties make AI a particularly destabilizing technology: (a) the massive cross-domain scale of diffusion, (b) rapid development and diffusion, (c) centralization of control #comment[AI coup would say "singular loyalties"], (d) non-detectable secret or misaligned loyalties #comment[mouthful], (e) potential for dependence (and human lock-out / loss of control?) #comment[TODO: Create better differences, be more principled. Also elaborate.]
